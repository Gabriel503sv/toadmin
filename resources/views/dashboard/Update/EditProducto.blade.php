...
@section('content')
    ...
    <div class="container text-center d-flex justity-content-center bg-white align-items-end border border-2 border-dark p-4 ">
        <form action="{{ route('producto.update', $producto->id) }}" method="POST" class="m-auto row g-3">
            ...
            @csrf
            <div class="col-md-12">
                <img width="200px" src="https://s3.amazonaws.com/lalishop.bucket-s3/{{ $producto->imagen_producto}}" alt="">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input name="nombre_producto" value="{{ @old('name') ?? $producto->nombre_producto }}" type="text" class="form-control"
            ...
            <div class="col-md-4">
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="precio_producto" type="text" class="form-control"
                        id="exampleInputEmail1" value="{{ @old('name') ?? $producto->precio_producto }}" aria-describedby="emailHelp" required>
                </div>
            </div>
            <div class="col-md-4">
                <label class="form-label" >Imagen</label>
                <div class="input-group mb-3">
                    <input name="imagen_producto" type="file" accept="image/*"
                    readonly disabled class="form-control" id="inputGroupFile02">
            ...
            <div class="col-md-2">
                ...
                <input name="compra"  type="number" class="form-control"
